...
export class VariableSelection extends React.Component {
    ...
    handleCategoricalChk(event){
        ...
        this.props.dispatch(changeSelectedVariableType(this.props.selVarSlug,this.props.getVarText,event))
    }
    renderAnalysisList(analysisList){
        ...
        let list =  analysisList.map((metaItem,metaIndex) =>{
            ...
            return(<div key={metaIndex} className={cls}><input id={id} type="checkbox" className="possibleAnalysis" value={metaItem.name} checked={metaItem.status} onChange={this.handleAnlysisList.bind(this)}  /><label htmlFor={id}>{metaItem.displayName}</label></div>);
        });
                                ...
                                <div className="col-md-12">
                                    <div className="panel panel-alt4 panel-alt4 cst-panel-shadow">
                                        ...
                                        <div className="panel-body text-center" id="analysisList" >
                                            <div className="ma-checkbox inline"><input id="allAnalysis" type="checkbox" className="allAnalysis" checked={store.getState().datasets.dataSetSelectAllAnalysis} onChange={this.handleAllAnlysis.bind(this)}  /><label htmlFor="allAnalysis">Select All</label></div>
                                            {renderSubList}
