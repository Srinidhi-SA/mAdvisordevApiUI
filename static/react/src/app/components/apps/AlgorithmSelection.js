                ...
                <div className="side-body">
                    ...
                    <div className="main-content">
                        <div className="panel panel-mAd xs-p-20 box-shadow">                               
                            ...
                            <Button id="algoSelectionProceed" type="button" bsStyle="primary" style={{float:'right',paddingLeft:20,paddingRight:20}} onClick={this.createModel.bind(this)}>{"Proceed"} <i class="fa fa-angle-double-right"></i></Button>
                            <div className="clearfix"></div>
                        </div>
                    </div>
